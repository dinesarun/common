...
var result = sc.textFile("file:///D:/SparkOutput/NasaCleanLogs");
...
dataframeWithSchema.coalesce(1).write.format("com.databricks.spark.csv").option("header","true").save("file:///D:/SparkOutput/SchemaDF");
